...
class ConvNet(nn.Module):
    def __init__(self, params = {}):
        ...
        self.conv2 = nn.Conv2d(in_channels=32, out_channels=32, kernel_size=(2,2), stride=(2,2)) # (64, 10, 10)
        ...
        self.fc_1 = nn.Linear(in_features=576, out_features=512)
        self.bn4 = nn.BatchNorm1d(512)
        self.fc_2 = nn.Linear(in_features=512, out_features=256)
        self.bn5 = nn.BatchNorm1d(256)
        self.fc_3 = nn.Linear(in_features=256, out_features=20)
