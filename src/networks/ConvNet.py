...
class ConvNet(nn.Module):
    def __init__(self, params = {}):
        ...
        self.name = "Conv-Net"
        self.conv1 = nn.Conv2d(in_channels=71, out_channels=64, kernel_size=(4,4), stride=(4,4))
        self.bn1 = nn.BatchNorm2d(64)
        self.drop1 = nn.Dropout2d(p=0.3)
        self.max_pool_1 = nn.MaxPool2d(2)
        self.conv2 = nn.Conv2d(in_channels=64, out_channels=128, kernel_size=(2,2)) # (64, 10, 10)
        self.bn2 = nn.BatchNorm2d(128)
        self.drop2 = nn.Dropout2d(p=0.3)
        self.max_pool_2 = nn.MaxPool2d(2)
        self.conv3 = nn.Conv2d(in_channels=128, out_channels=256, kernel_size=(2,2)) # (64, 10, 10)
        self.bn3 = nn.BatchNorm2d(256)
        self.drop3 = nn.Dropout2d(p=0.3)
        self.max_pool_3 = nn.MaxPool2d(2)
        self.conv4 = nn.Conv2d(in_channels=256, out_channels=512, kernel_size=(2,2)) # (64, 10, 10)
        self.bn4_ = nn.BatchNorm2d(512)
        self.drop4 = nn.Dropout2d(p=0.3)
        self.max_pool_4 = nn.MaxPool2d(2)
        self.fc_1 = nn.Linear(in_features=4608, out_features=2048)
