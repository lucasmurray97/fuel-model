...
class ConvNet(nn.Module):
    def __init__(self, params = {}):
        ...
        self.conv2 = nn.Conv2d(in_channels=16, out_channels=32, kernel_size=(2,2)) # (64, 10, 10)
        self.bn2 = nn.BatchNorm2d(32)
        self.max_pool_2 = nn.MaxPool2d(2)
        self.conv3 = nn.Conv2d(in_channels=32, out_channels=64, kernel_size=(2,2)) # (64, 10, 10)
        self.bn3 = nn.BatchNorm2d(64)
        self.max_pool_3 = nn.MaxPool2d(2)
        self.conv4 = nn.Conv2d(in_channels=64, out_channels=128, kernel_size=(2,2)) # (64, 10, 10)
        self.bn4_ = nn.BatchNorm2d(128)
        self.max_pool_4 = nn.MaxPool2d(2)
        self.fc_1 = nn.Linear(in_features=1152, out_features=1024)
        self.bn4 = nn.BatchNorm1d(1024)
        self.fc_2 = nn.Linear(in_features=1024, out_features=512)
        self.bn5 = nn.BatchNorm1d(512)
        self.fc_3 = nn.Linear(in_features=512, out_features=256)
        self.bn6 = nn.BatchNorm1d(256)
        self.fc_4 = nn.Linear(in_features=256, out_features=20)
    ...
    def forward(self, x):
        ...
        #print(x.shape)
        x = self.max_pool_4(F.relu(self.bn4_(self.conv4(x))))
        #print(x.shape)
